...
<div className="relative h-screen mx-auto">
    ...
    <div className="absolute inset-0 items-center text-center justify-content-center md:mt-64 sm:mt-20">
        ...
        <Link to="/van" type="button" class="text-white bg-amber-600  hover:bg-amber-700 focus:ring-2 focus:ring-amber-400 font-medium rounded-lg  text-sm  py-2.5 me-4 mb-4 px-20  focus:outline-none dark:focus:ring-blue-800  
">Find your van</Link>
    </div>
</div>
<Footer/>
